...
Sumo.prototype.connect = function (callback) {
    this.discover(function (data, err) {
        if (err) {
            ...
            try {
                if (this._d2cServer) {
                    this._d2cServer.close();
                    this._d2cServer = null;
                }
...
Sumo.prototype.disconnect = function () {
...
Sumo.prototype.discover = function (callback) {
    ...
    this._discoveryClient.on("error", function (err) {
        callback(null, err);
    }.bind(this));
};
                    ...
                    case constants.ARCOMMANDS_ID_JUMPINGSUMO_CLASS_MEDIASTREAMINGSTATE:
                        switch (commandId) {
                            case constants.ARCOMMANDS_ID_JUMPINGSUMO_MEDIASTREAMINGSTATE_CMD_VIDEOENABLECHANGED:
                                console.log("video streaming state changed");
                                break;
                            case constants.ARCOMMANDS_JUMPINGSUMO_MEDIASTREAMINGSTATE_VIDEOENABLECHANGED_ENABLED_ENABLED:
                                console.log("video enable");
                                break;
                            case constants.ARCOMMANDS_JUMPINGSUMO_MEDIASTREAMINGSTATE_VIDEOENABLECHANGED_ENABLED_DISABLED:
                                console.log("video disable");
                                break;
                            case constants.ARCOMMANDS_JUMPINGSUMO_MEDIASTREAMINGSTATE_VIDEOENABLECHANGED_ENABLED_ERROR:
                                console.log("video err");
                                break;
                            case constants.ARCOMMANDS_JUMPINGSUMO_MEDIASTREAMINGSTATE_VIDEOENABLECHANGED_ENABLED_MAX:
                                console.log("video max");
                                break;
                            default:
...
Sumo.prototype.videoStreaming = function (opts) {

    opts = opts || {};
    opts.enabled = opts.enabled || 1;
