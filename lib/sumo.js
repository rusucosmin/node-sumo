...
Sumo.prototype._packetReceiver = function (message) {
    ...
    //console.log("networkFrame is", JSON.stringify(networkFrame));
    if (networkFrame.type === constants.ARNETWORKAL_FRAME_TYPE_DATA &&
        networkFrame.id === constants.BD_NET_DC_VIDEO_DATA_ID2) {
...
Sumo.prototype._writePacket = function (packet) {
    if (this._c2dClient) {
        this._c2dClient.close();
        this._c2dClient = null;
    }
